...
class Room(
    ...
    fun addSerializedDrawAction(drawAction: String){
        curRoundDrawData = curRoundDrawData + drawAction
    }


    private suspend fun finishedOffDrawing(){
        lastDrawData?.let {
    ...
    suspend fun addPlayer(clientId: String,username: String,socketSession: WebSocketSession): Player{
        ...
        val announcement = Announcement(
            ...
            Announcement.TYPE_PLAYED_JOINED
        )
